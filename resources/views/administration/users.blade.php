...
<!-- Mirrored from smarthr.dreamstechnologies.com/laravel/template/public/users by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 02:23:15 GMT -->
<!-- Added by HTTrack -->
...
<body>
                                        ...
                                        <td class="text-end">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_user"><i class="fa-regular fa-trash-can m-r-5"></i>
                                                        Delete</a>
                                                </div>
                                            </div>
                                        </td>
    ...
    <!-- Optional: Cloudflare email decoding script -->
    ...
    <script src="{{ asset('cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}" data-cf-settings="fde0f1bfd6b510cac10ebba2-|49" defer></script>
