        ...
        <div class="content container-fluid">
          ...
          <div class="filter-section">
            <ul>
              <li>
                <div class="view-icons">
                  <a href="{{route('companies')}}" class="list-view btn btn-link active"
                    ><i class="las la-list"></i
                  ></a>
                  <a href="{{route('companies-grid')}}" class="grid-view btn btn-link"
                    ><i class="las la-th"></i
                  ></a>
                </div>
              </li>
...
<script src="{{ asset('../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}"
        data-cf-settings="29167b12d39ae624b79996cb-|49" defer></script>
