...
>
  <!-- Mirrored from smarthr.dreamstechnologies.com/laravel/template/public/leads-dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 02:22:18 GMT -->
              ...
              <ul class="list-inline-item list-unstyled links">
                ...
                <li class="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      <a class="active" href="leads-dashboard.html"
                        >Leads Dashboard</a
                      >
                    </li>
                  </ul>
            ...
            <ul class="sidebar-vertical">
              ...
              <li class="submenu">
                ...
                <ul>
                  ...
                  <li>
                    <a class href="{{url('/deals-dashboard')}}">Deals Dashboard</a>
                  </li>
                  <li>
                    <a class="active" href="{{url('/leads-dashboard')}}"
                      >Leads Dashboard</a
                    >
                  </li>
                </ul>
              ...
              {{-- <li class="submenu">
                <a href="#"
                  ><i class="la la-briefcase"></i> <span> Jobsss </span>
                  <span class="menu-arrow"></span
                ></a>
                <ul>
                  <li>
                        ...
                        <tr>
                          ...
                          <td>
                            <h2 class="table-avatar d-flex">
                              <a href="company-details.html" class="avatar"
                                ><img
                              ...
                              <a
                                ...
                                >NovaWave LLC<span>Newyork, USA</span></a
                              >
                            </h2>
                          </td>
                          <td>+1 989757485</td>
                          ...
                          <td>
                            <h2 class="table-avatar d-flex">
                              ...
                              <a
                                href="company-details.html"
                                class="profile-split d-flex flex-column"
                                >SilverHawk<span>Jametown, NY</span></a
                              >
                            </h2>
                          </td>
                          <td>+1 546555455</td>
                          ...
                          <td>
                            <h2 class="table-avatar d-flex">
                              ...
                              <a
                                href="company-details.html"
                                class="profile-split d-flex flex-column"
                                >SummitPeak<span>Compton, RI</span></a
                              >
                            </h2>
                          </td>
                          <td>+1 454478787</td>
...
<script src="{{ asset('assets/js/app.js') }}"></script>
  ...
  <!-- Mirrored from smarthr.dreamstechnologies.com/laravel/template/public/leads-dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 02:22:21 GMT -->
</html>
