        ...
        <div class="content container-fluid">
          ...
          <div class="filter-section">
            <ul>
              <li>
                <div class="view-icons">
                  <a href="{{route('leads')}}" class="list-view btn btn-link active"
                    ><i class="las la-list"></i
                  ></a>
                  <a href="{{route('leads-kanban')}}" class="grid-view btn btn-link"
                    ><i class="las la-th"></i
                  ></a>
                </div>
              </li>
                ...
                >
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <h2>
                          <a href="{{route('leads-details')}}" class="profile-split"
                            >Collins</a
                          >
                        </h2>
                      </td>
                        ...
                        <div class="dropdown dropdown-action">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a
                              ...
                              Delete</a
                            >
                            <a class="dropdown-item" href="{{route('leads-details')}}"
                  ...
                  <div class="success-message text-center">
                    ...
                    <div class="col-lg-12 text-center form-wizard-button">
                      <a
                        ...
                        >Not Now</a
                      >
                      <a href="{{route('leads')}}" class="btn btn-primary">Okay</a>
                    </div>
                  </div>
                </div>
              </div>
