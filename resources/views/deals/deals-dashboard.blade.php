...
>
  <!-- Mirrored from smarthr.dreamstechnologies.com/laravel/template/public/deals-dashboard by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 02:22:18 GMT -->
          ...
          <div id="sidebar-menu" class="sidebar-menu">
            <nav class="greedys sidebar-horizantal">
              <ul class="list-inline-item list-unstyled links">
                ...
                <li class="submenu">
                  ...
                  <ul>
                    <li>
                      <a class href="admin-dashboard.html">Admin Dashboardd</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a class="active" href="deals-dashboard.html"
                        >Deals Dashboard</a
                      >
                    </li>
                    <li>
              ...
              <ul class="hidden-links hidden">
                ...
                <li class="submenu">
                  <a href="#"
                    ><i class="la la-briefcase"></i> <span> Job </span>
                    <span class="menu-arrow"></span
                  ></a>
                  <ul>
                    <li>
            ...
            <ul class="sidebar-vertical">
              ...
              <li class="submenu">
                ...
                <ul>
                  <li>
                    <a class href="{{url('/admin-dashboard')}}" class="active"
                      >Admin Dashboard</a
                    >
                  </li>
                  <li>
                    <a class href="{{url('/employee-dashboard')}}"
                      >Employee Dashboard</a
                    >
                  </li>
                  <li>
                    <a class="active" href="{{url('/deals-dashboard')}}"
                      >Deals Dashboard</a
                    >
                  </li>
                  <li>
                    <a class href="{{url('/leads-dashboard')}}">Leads Dashboard</a>
                  </li>
                </ul>
              </li>
              <li class="submenu">
              ...
              {{-- <li class="submenu">
                <a href="#"
                  ><i class="la la-briefcase"></i> <span> Jobss </span>
                  <span class="menu-arrow"></span
                ></a>
                <ul>
                  <li>
              ...
              <li class="submenu">
                <a href="#"
                  ><i class="la la-columns"></i> <span> Pages s</span>
                  <span class="menu-arrow"></span
                ></a>
                <ul>
                  <li><a class href="search.html"> Search </a></li>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-8 float-end ms-auto">
                <div class="d-flex title-head">
                  ...
                  <div class="form-sort">
                    <a href="javascript:void(0);" class="list-view btn btn-link"
            ...
            <div class="col-md-6 d-flex">
              <div class="card analytics-card w-100">
                <div class="card-body">
                  <div class="statistic-header">
                    <h4>
                      Recently Created Contacts<a href="#" class="text-muted"
                        ><i class="la la-link ms-1"></i
                      ></a>
                    </h4>
                    <div class="dropdown statistic-dropdown">
                      <div class="card-select">
                    ...
                    <table class="table custom-table table-nowrap mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>85%</td>
                          <td>
                            <span class="badge bg-inverse-danger">Lost</span>
                          </td>
                        </tr>
                        <tr>
                          <td>Adams</td>
                          ...
                          <td>80%</td>
                          <td>
                            <span class="badge bg-inverse-success">Won</span>
                          </td>
                        </tr>
                        <tr>
                          <td>Schumm</td>
