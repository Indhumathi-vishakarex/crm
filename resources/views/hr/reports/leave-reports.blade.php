...
>
  <!-- Mirrored from smarthr.dreamstechnologies.com/laravel/template/public/leave-reports by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 02:23:09 GMT -->
                ...
                <table class="table table-striped custom-table mb-0 datatable">
                  ...
                  <tbody>
                    <tr>
                        ...
                        <h2 class="table-avatar">
                          <a href="{{route('profile')}}" class="avatar"
                            ><img
                              ...
                              alt="User Image"
                          /></a>
                          <a href="{{route('profile')}}">John Doe <span>#0001</span></a>
                        </h2>
                      </td>
                      <td>20 Dec 2020</td>
                      <td>Design</td>
                      ...
                      <td class="text-center">
                        <span class="btn btn-danger btn-sm">05</span>
                      </td>
                      <td class="text-center">
                        <span class="btn btn-warning btn-sm"><b>08</b></span>
                      </td>
                      <td class="text-center">
                        <span class="btn btn-success btn-sm"><b>20</b></span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <span class="btn btn-danger btn-sm">03</span>
                      </td>
                      <td class="text-center">
                        <span class="btn btn-warning btn-sm"><b>08</b></span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <span class="btn btn-danger btn-sm">01</span>
                      </td>
                      <td class="text-center">
                        <span class="btn btn-warning btn-sm"><b>09</b></span>
                      </td>
                      <td class="text-center">
                        <span class="btn btn-success btn-sm"><b>20</b></span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <span class="btn btn-danger btn-sm">15</span>
                      </td>
                      <td class="text-center">
                        <span class="btn btn-warning btn-sm"><b>05</b></span>
                      </td>
                      <td class="text-center">
                        <span class="btn btn-success btn-sm"><b>20</b></span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <span class="btn btn-danger btn-sm">10</span>
                      </td>
                      <td class="text-center">
                        <span class="btn btn-warning btn-sm"><b>07</b></span>
                      </td>
                      <td class="text-center">
                        <span class="btn btn-success btn-sm"><b>20</b></span>
                      </td>
...
<script src="{{ asset('cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}"
        data-cf-settings="9c2d1679cd2d4288d9f9efd0-|49" defer></script>
