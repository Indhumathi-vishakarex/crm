...
<!-- Mirrored from smarthr.dreamstechnologies.com/laravel/template/public/project-reports by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 02:23:08 GMT -->
<!-- Added by HTTrack -->
<meta
        ...
        <div id="sidebar-menu" class="sidebar-menu">
          <nav class="greedys sidebar-horizantal">
            <ul class="list-inline-item list-unstyled links">
              ...
              <li class="submenu">
                <a href="#"><i class="la la-dashcube"></i> <span> Dashboard</span>
            ...
            <ul class="hidden-links hidden">
              ...
              <li class="submenu">
                ...
                <ul>
                  ...
                  <li>
                    <a class="active" href="project-reports.html">
                      Project Report
                    </a>
                  </li>
              ...
              <li>
                <a class href="promotion.html"><i class="la la-bullhorn"></i> <span>Promotion</span></a>
              </li>
              <li>
                <a class href="resignation.html"><i class="la la-external-link-square"></i>
                  <span>Resignation</span></a>
              </li>
              <li>
                <a class href="termination.html"><i class="la la-times-circle"></i>
              ...
              <li>
                <a class href="knowledgebase.html"><i class="la la-question"></i>
              ...
              <li class="submenu">
                <a href="#"><i class="la la-dropbox"></i> <span> Advanced UI </span>
                  <span class="menu-arrow"></span></a>
                <ul>
          ...
          <ul class="sidebar-vertical">
            ...
            <li class="submenu">
              ...
              <ul>
                <li>
                  <a class href="admin-dashboard.html" class="active">Admin Dashboard</a>
                </li>
                <li>
                  <a class href="employee-dashboard.html">Employee Dashboard</a>
                </li>
            ...
            <li class="submenu">
              <a href="#"><i class="la la-file-alt"></i> <span> Accounting </span>
                <span class="menu-arrow"></span></a>
              <ul>
                <li><a class href="categories.html">Categories</a></li>
                <li><a class href="budgets.html">Budgets</a></li>
            ...
            <li class="submenu">
              <a href="#"><i class="la la-money-bill-wave"></i> <span> Payroll </span>
                <span class="menu-arrow"></span></a>
              <ul>
                <li><a class href="salary.html"> Employee Salary </a></li>
                <li><a class href="salary-view.html"> Payslip </a></li>
            ...
            <li class="submenu">
              <a href="#"><i class="la la-chart-pie"></i> <span> Reports </span>
                <span class="menu-arrow"></span></a>
              <ul>
                <li>
                  <a class href="expense-reports.html"> Expense Report </a>
            ...
            <li class="submenu">
              <a href="#"><i class="la la-laptop-medical"></i>
                <span> Performance </span> <span class="menu-arrow"></span></a>
              <ul>
                <li>
                  <a class href="performance-indicator.html">
            ...
            <li class="submenu">
              <a href="#"><i class="la la-external-link-square"></i>
            ...
            <li class="submenu">
              <a href="#"><i class="la la-user-tag"></i> <span> Profile </span>
                <span class="menu-arrow"></span></a>
              <ul>
                <li><a class href="profile.html"> Employee Profile </a></li>
                <li>
            ...
            <li class="submenu">
              <a href="#"><i class="la la-history"></i> <span> Subscriptions </span>
                <span class="menu-arrow"></span></a>
              <ul>
                <li>
                  <a class href="subscriptions.html">
            ...
            <li class="submenu">
              <a href="#"><i class="lab la-uikit"></i> <span> Base UI </span>
                <span class="menu-arrow"></span></a>
              <ul>
                <li><a class href="ui-alerts.html">Alerts</a></li>
                <li><a class href="ui-accordion.html">Accordion</a></li>
            ...
            <li class="submenu">
              <a href="#"><i class="la la-eject"></i> <span> Advanced UI </span>
                <span class="menu-arrow"></span></a>
              <ul>
                <li><a class href="ui-ribbon.html">Ribbon</a></li>
                <li><a class href="ui-clipboard.html">Clipboard</a></li>
            ...
            <li class="submenu">
              <a href="#"><i class="la la-chart-line"></i> <span> Charts </span>
                <span class="menu-arrow"></span></a>
              <ul>
                <li><a class href="chart-apex.html">Apex Charts</a></li>
                <li><a class href="chart-js.html">Chart Js</a></li>
            ...
            <li class="submenu">
              <a href="#"><i class="la la-wpforms"></i> <span> Forms </span>
                <span class="menu-arrow"></span></a>
              <ul>
                <li>
                  <a class href="form-basic-inputs.html">Basic Inputs </a>
                      ...
                      <ul class="team-members">
                        ...
                        <li>
                          <a
                            ...
                            title
                            data-bs-toggle="tooltip"
                            data-original-title="Richard Miles"><img
                              src="assets/img/profiles/avatar-09.jpg"
                              alt="User Image" /></a>
                        </li>
                        <li>
                          <a
                            ...
                            title
                            data-bs-toggle="tooltip"
                            data-original-title="John Smith"><img
                        ...
                        <li>
                          <a
                            ...
                            title
                            data-bs-toggle="tooltip"
                            data-original-title="Mike Litorus"><img
                              src="assets/img/profiles/avatar-05.jpg"
                              alt="User Image" /></a>
                        </li>
                        <li>
