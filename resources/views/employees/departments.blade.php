...
<link rel="stylesheet" href="{{ asset('assets/css/style.css') }}" />
  ...
  <script src="{{ asset('assets/js/jquery-3.7.1.min.js') }}" type="e57cb3147179e69f37cced13-text/javascript"></script>
<script src="{{ asset('assets/js/bootstrap.bundle.min.js') }}" type="e57cb3147179e69f37cced13-text/javascript"></script>
<script src="{{ asset('assets/js/jquery.slimscroll.min.js') }}" type="e57cb3147179e69f37cced13-text/javascript"></script>
<script src="{{ asset('assets/js/jquery.dataTables.min.js') }}" type="e57cb3147179e69f37cced13-text/javascript"></script>
<script src="{{ asset('assets/js/dataTables.bootstrap4.min.js') }}" type="e57cb3147179e69f37cced13-text/javascript"></script>
<script src="{{ asset('assets/js/feather.min.js') }}" type="e57cb3147179e69f37cced13-text/javascript"></script>
<script src="{{ asset('assets/js/layout.js') }}" type="e57cb3147179e69f37cced13-text/javascript"></script>
<script src="{{ asset('assets/js/theme-settings.js') }}" type="e57cb3147179e69f37cced13-text/javascript"></script>
<script src="{{ asset('assets/js/greedynav.js') }}" type="e57cb3147179e69f37cced13-text/javascript"></script>
<script src="{{ asset('assets/js/app.js') }}" type="e57cb3147179e69f37cced13-text/javascript"></script>

<script src="{{ asset('../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}" data-cf-settings="e57cb3147179e69f37cced13-|49" defer></script>
