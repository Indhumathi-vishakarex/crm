            ...
            <div class="sidebar sidebar-twocol" id="navbar-nav">
                <div class="sidebar-left slimscroll">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                        ...
                        <a class="nav-link active" id="v-pills-projects-tab" title="Projects" data-bs-toggle="pill"
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-end ms-auto">
                            ...
                            <div class="view-icons">
                                <a href="{{route('projects')}}" class="grid-view btn btn-link"><i
                                        class="fa fa-th"></i></a>
                                <a href="{{route('project-list')}}" class="list-view btn btn-link active"><i
                                            ...
                                            <ul class="team-members text-nowrap">
                                                <li>
                                                    <a href="#" title="John Doe"
                                                        data-bs-toggle="tooltip"><img alt
                                                            src="assets/img/profiles/avatar-02.jpg"></a>
                                                </li>
                                                <li>
                                                    <a href="#" title="Richard Miles"
                                                        data-bs-toggle="tooltip"><img alt
                                                            src="assets/img/profiles/avatar-09.jpg"></a>
                                                </li>
                                                <li>
                                                    <a href="#" title="John Smith"
                                                        data-bs-toggle="tooltip"><img alt
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown action-label">
                                                <a href class="btn btn-white btn-sm btn-rounded dropdown-toggle"
                                                    data-bs-toggle="dropdown" aria-expanded="false"><i
                                                        class="fa-regular fa-circle-dot text-danger"></i> Inactive
                                                </a>
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#"><i
                                                            class="fa-regular fa-circle-dot text-success"></i>
...
<script defer src="{{ asset('cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}"
        data-cf-settings="12e2e4f88ce415ba2f7ef9d5-|49"></script>
