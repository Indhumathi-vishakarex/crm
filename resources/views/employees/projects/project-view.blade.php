            ...
            <div class="sidebar sidebar-twocol" id="navbar-nav">
                <div class="sidebar-left slimscroll">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                        ...
                        <a class="nav-link " id="v-pills-accounting-tab" title="Accounting"
                            data-bs-toggle="pill" href="#v-pills-accounting" role="tab"
                            aria-controls="v-pills-accounting" aria-selected="false">
                            <span class="material-icons-outlined">
                        ...
                        <a class="nav-link  " id="v-pills-activities-tab" title="Activities"
                            data-bs-toggle="pill" href="#v-pills-activities" role="tab"
                ...
                <div class="sidebar-right">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show  " id="v-pills-dashboard" role="tabpanel"
                        ...
                        <div class="tab-pane fade show " id="v-pills-users" role="tabpanel"
                            aria-labelledby="v-pills-activities-tab">
                            <p>Users</p>
                            <ul>
                        ...
                        <div class="tab-pane fade show  " id="v-pills-authentication" role="tabpanel"
                        ...
                        <div class="tab-pane fade show " id="v-pills-errorpages" role="tabpanel"
                        ...
                        <div class="tab-pane fade show " id="v-pills-subscriptions" role="tabpanel"
                        ...
                        <div class="tab-pane fade show " id="v-pills-pages" role="tabpanel"
                        ...
                        <div class="tab-pane fade show  " id="v-pills-baseui" role="tabpanel"
                        ...
                        <div class="tab-pane fade show " id="v-pills-elements" role="tabpanel"
                        ...
                        <div class="tab-pane fade show " id="v-pills-charts" role="tabpanel"
                        ...
                        <div class="tab-pane fade show " id="v-pills-icons" role="tabpanel"
                        ...
                        <div class="tab-pane fade show " id="v-pills-forms" role="tabpanel"
                        ...
                        <div class="tab-pane fade show " id="v-pills-tables" role="tabpanel"
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-end ms-auto">
                            <a href="#" class="btn add-btn" data-bs-toggle="modal"
                                data-bs-target="#edit_project"><i class="fa-solid fa-plus"></i> Edit
                                Project</a>
                            <a href="{{route('task-board')}}" class="btn btn-white float-end me-3"
                                data-bs-toggle="tooltip" title="Task Board"><i class="fa-solid fa-bars"></i></a>
                            ...
                            <div class="card-body">
                                <div class="project-title">
                                    ...
                                    <small class="block text-ellipsis m-b-15"><span class="text-xs">2</span> <span
                                            ...
                                            tasks, </span><span class="text-xs">5</span> <span
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel elit neque. Class
                                    ...
                                    sollicitudin
                                    libero vitae est consectetur, a molestie tortor consectetur. Aenean tincidunt
                                    interdum ipsum, id
                                    pellentesque diam suscipit ut. Vivamus massa mi, fermentum eget neque eget,
                                    imperdiet tristique
                                    ...
                                    hendrerit diam
                                    aliquet. Proin tincidunt porttitor ligula, a tincidunt orci pellentesque nec. Ut
                                    ultricies maximus
                                    nulla id consequat. Fusce eu consequat mi, eu euismod ligula. Aliquam porttitor
                                    neque id massa
                                    porttitor, a pretium velit vehicula. Morbi volutpat tincidunt urna, vel ullamcorper
                                    ligula fermentum
                                    at. </p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel elit neque. Class
                                    aptent taciti
                                    ...
                                    <li>
                                        <div class="files-cont">
                                            ...
                                            <div class="files-info">
                                                <span class="file-name text-ellipsis"><a href="#">AHA Selfcare
                                                        Mobile Application
                                        ...
                                        <div class="files-cont">
                                            ...
                                            <div class="files-info">
                                                <span class="file-name text-ellipsis"><a href="#">AHA Selfcare
                                                        Mobile Application
                                                        Test-Cases.xls</a></span>
                                                <span class="file-author"><a href="#">Richard Miles</a></span>
                                                <span class="file-date">May 31st at 6:53 PM</span>
                                                <div class="file-size">Size: 14.8Mb</div>
                                            </div>
                                            <ul class="files-action">
                        ...
                        <div class="project-task">
                            <ul class="nav nav-tabs nav-tabs-top nav-justified mb-0">
                                <li class="nav-item"><a class="nav-link active" href="#all_tasks"
                                        data-bs-toggle="tab" aria-expanded="true">All Tasks</a></li>
                                <li class="nav-item"><a class="nav-link" href="#pending_tasks"
                                        data-bs-toggle="tab" aria-expanded="false">Pending Tasks</a></li>
                                <li class="nav-item"><a class="nav-link" href="#completed_tasks"
                                        data-bs-toggle="tab" aria-expanded="false">Completed Tasks</a></li>
                            </ul>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="#"><i
                                                            ...
                                                            Highest priority</a>
                                                        <a class="dropdown-item" href="#"><i
                                                                class="fa-regular fa-circle-dot text-info"></i> High
                                                            priority</a>
                                                        <a class="dropdown-item" href="#"><i
                                                                class="fa fa-dot-circle-o text-primary"></i> Normal
                                                            priority</a>
                                                        <a class="dropdown-item" href="#"><i
                                                                class="fa-regular fa-circle-dot text-success"></i> Low
                                                            priority</a>
                                                    </div>
                                                </div>
                                            </td>
...
<script defer src="{{ asset('cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}"
        data-cf-settings="d92f15482f43b441c5170c82-|49"></script>
