...
<!-- Mirrored from smarthr.dreamstechnologies.com/laravel/template/public/leaves by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 02:22:31 GMT -->
...
<td>
<h2 class="table-avatar">
<a href="{{route('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-24.jpg" alt="User Image"></a>
...
<td>
<h2 class="table-avatar">
<a href="{{route('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-08.jpg" alt="User Image"></a>
...
<td>
<h2 class="table-avatar">
<a href="{{route('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-15.jpg" alt="User Image"></a>
...
<td>
<h2 class="table-avatar">
<a href="{{route('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-20.jpg" alt="User Image"></a>
...
<td>
<h2 class="table-avatar">
<a href="{{route('profile')}}" class="avatar"><img src="assets/img/profiles/avatar-25.jpg" alt="User Image"></a>
...
<!-- Cloudflare Rocket Loader (keep as-is if used) -->
<script src="../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="e33f87de800523d20cbe933b-|49" defer></script>
</body>

<!-- Mirrored from smarthr.dreamstechnologies.com/laravel/template/public/leaves by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 02:22:35 GMT -->
</html>
