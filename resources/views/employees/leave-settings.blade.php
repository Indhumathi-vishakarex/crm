...
<link rel="stylesheet" href="{{ asset('assets/css/style.css') }}">
  ...
  <body>
              ...
              <ul class="list-inline-item list-unstyled links">
                ...
                <li class="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      <a class="active" href="leave-settings.html"
                        >Leave Settings</a
                      >
                    </li>
                    <li>
   ...
   <script src="{{ asset('assets/js/jquery-3.7.1.min.js') }}" type="3d9d90305e721de9229e87f8-text/javascript"></script>

<script src="{{ asset('assets/js/bootstrap.bundle.min.js') }}" type="3d9d90305e721de9229e87f8-text/javascript"></script>

<script src="{{ asset('assets/js/jquery.slimscroll.min.js') }}" type="3d9d90305e721de9229e87f8-text/javascript"></script>

<script src="{{ asset('assets/js/moment.min.js') }}" type="3d9d90305e721de9229e87f8-text/javascript"></script>
<script src="{{ asset('assets/js/bootstrap-datetimepicker.min.js') }}" type="3d9d90305e721de9229e87f8-text/javascript"></script>

<script src="{{ asset('assets/js/feather.min.js') }}" type="3d9d90305e721de9229e87f8-text/javascript"></script>

<script src="{{ asset('assets/js/layout.js') }}" type="3d9d90305e721de9229e87f8-text/javascript"></script>
<script src="{{ asset('assets/js/theme-settings.js') }}" type="3d9d90305e721de9229e87f8-text/javascript"></script>
<script src="{{ asset('assets/js/greedynav.js') }}" type="3d9d90305e721de9229e87f8-text/javascript"></script>

<script src="{{ asset('assets/js/app.js') }}" type="3d9d90305e721de9229e87f8-text/javascript"></script>

<script src="{{ asset('../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}" data-cf-settings="3d9d90305e721de9229e87f8-|49" defer></script>
