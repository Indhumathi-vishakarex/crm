                    ...
                    <div class="account-wrapper">
                        ...
                        <form action="{{ url('/admin') }}" method="">
                            ...
                            <div class="input-block mb-4">
                                ...
                                <input class="form-control" type="text" name="email" id="email" placeholder="email" autocomplete="off" value="">
                            ...
                            <div class="input-block mb-4">
                                ...
                                <div class="position-relative">
                                    <input class="form-control" type="password" id="password" name="password" placeholder="password" autocomplete="new-password" value="">
