              ...
              <ul class="hidden-links hidden">
                ...
                <li class="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      <a class href="{{route('payment-reports')}}">
                        Payments Report
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a class href="{{route('employee-reports')}}">
                        Employee Report
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a class href="{{route('leave-reports')}}"> Leave Report </a>
                    </li>
                    <li>
                      <a class href="{{route('daily-reports')}}"> Daily Report </a>
                    </li>
                  </ul>
                </li>
                <li class="menu-title">
                ...
                <div class="sidebar-right">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show  active" id="v-pills-dashboard" role="tabpanel" aria-labelledby="v-pills-dashboard-tab">
                            ...
                            <ul>
                                <li>
                                    <a class="active" href="{{ route('admin-dashboard') }}">Admin Dashboard</a>
                                </li>
                                <li>
                                    <a class href="{{ route('employee-dashboard') }}">Employee Dashboard</a>
                                </li>
