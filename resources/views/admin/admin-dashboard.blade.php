...
<a href="#"><i class="la la-dashcube"></i> <span> Dashboard</span> <span class="menu-arrow"></span></a>
<ul>
<li><a class="active" href="{{url('/admin-dashboard')}}" class="active">Admin Dashboard</a></li>
<li><a class href="{{url('/employee-dashboard')}}">Employee Dashboard</a></li>
<li><a class href="{{url('/deals-dashboard')}}">Deals Dashboard</a></li>
<li><a class href="{{url('/leads-dashboard')}}">Leads Dashboard</a></li>
</ul>
</li>
<li class="submenu">
<a href="#"><i class="la la-cube"></i> <span> Apps</span> <span class="menu-arrow"></span></a>
<ul>
<li><a class href="{{url('/chat')}}">Chat</a></li>
<li class="submenu">
<a href="{{url('/voice-call')}}"><span> Calls</span> <span class="menu-arrow"></span></a>
<ul>
<li><a class href="voice-call.html">Voice Call</a></li>
<li><a class href="video-call.html">Video Call</a></li>
<li><a class href="outgoing-call.html">Outgoing Call</a></li>
...
{{-- <li class="submenu">
<a href="#"><i class="la la-columns"></i> <span> Pagess </span> <span class="menu-arrow"></span></a>
<ul>
<li><a class href="search.html"> Search </a></li>
<li><a class href="faq.html"> FAQ </a></li>
<li><a class href="terms.html"> Terms </a></li>
