...
>
  <!-- Mirrored from smarthr.dreamstechnologies.com/laravel/template/public/outgoing-call by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Aug 2024 02:22:23 GMT -->
...
<link rel="stylesheet" href="{{ asset('assets/css/style.css') }}" />
  ...
  <body>
    ...
    <script src="{{ asset('assets/js/jquery-3.7.1.min.js') }}" type="8f6efbbab786c1238e17a6b6-text/javascript"></script>

<script src="{{ asset('assets/js/bootstrap.bundle.min.js') }}" type="8f6efbbab786c1238e17a6b6-text/javascript"></script>

<script src="{{ asset('assets/js/jquery.slimscroll.min.js') }}" type="8f6efbbab786c1238e17a6b6-text/javascript"></script>

<script src="{{ asset('assets/js/feather.min.js') }}" type="8f6efbbab786c1238e17a6b6-text/javascript"></script>

<script src="{{ asset('assets/js/layout.js') }}" type="8f6efbbab786c1238e17a6b6-text/javascript"></script>
<script src="{{ asset('assets/js/theme-settings.js') }}" type="8f6efbbab786c1238e17a6b6-text/javascript"></script>
<script src="{{ asset('assets/js/greedynav.js') }}" type="8f6efbbab786c1238e17a6b6-text/javascript"></script>

<script src="{{ asset('assets/js/app.js') }}" type="8f6efbbab786c1238e17a6b6-text/javascript"></script>

<script src="{{ asset('../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js') }}" data-cf-settings="8f6efbbab786c1238e17a6b6-|49" defer></script>
